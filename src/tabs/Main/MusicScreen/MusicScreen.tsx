...
import { CurrentMusicDuration, CurrentMusicSeeker, Header } from "../../../components";
    ...
    <Container>
      ...
      {musicState.currentMusic && (
        <View>
          ...
          <Text style={styles.title}>{musicState.currentMusic.asset.filename}</Text>
          ...
          <View style={styles.actionBtnContainer}>
            ...
            <CurrentMusicActionButtons style={styles.actionBtn} varient="full" />
